...
Refinery::Images.configure do |config|
  ...
  config.user_image_sizes = {:small=>"110x110>", :medium=>"450x450>", :large=>"1280x200>"}
  ...
  config.dragonfly_secret = "749da0ade2cfae7cec40e34e08a8299fbc732ac33acf4a9f"
  # config.dragonfly_url_format = "/system/images/:job/:basename.:ext"
  # config.dragonfly_url_host = ""
  # config.datastore_root_path = "/home/iv/rails_projects/test_refinery/public/system/refinery/images"
